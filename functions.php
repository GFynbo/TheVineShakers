...
add_action( 'genesis_after', 'genesis_custom_footer' );
function genesis_custom_footer() {
	?>
	<p>&copy; Copyright 2017 <a href="http://thevineshakers.com/">The Vine Shakers</a> &middot; All Rights Reserved</p>
	<?php
}
